...
async function runScenario() {
    ...
    const establishColony = (state: GameState, planetId: string, name: string): string => {
        ...
        const newColony: Colony = {
            ...
            factories: 0, mines: 0, civilianFactories: 0, civilianMines: 0, researchLabs: 0, spaceport: 0, shipyards: [], groundDefenses: 0, constructionOffices: 0, farms: 0, stores: 0, terraformProgress: 0, aethericDistillery: 0,
